...
public class DeIndentify   {

	static Logger logger = Logger.getLogger(DeIndentify.class.getName());
	...
	public static void main(String[] args) throws Exception {
	        ...
	        FileInputFormat.setInputPaths(job, new Path("/user/healthcare/input/healthcare_Sample_dataset_4.0.csv"));
	        FileOutputFormat.setOutputPath(job, new Path("/user/healthcare/mr-out"));
	 
	        job.setJarByClass(DeIndentify.class);
	        job.setUser("healthcare");
