...
public class WeatherData {
	...
	public static void main(String[] args) throws Exception {
		...
		conf.setUser("weather");
		FileInputFormat.setInputPaths(conf, new Path("/user/weather/input/Weather_dataset_4.0.txt"));
		FileOutputFormat.setOutputPath(conf, new Path("/user/weather/mr-out"));
